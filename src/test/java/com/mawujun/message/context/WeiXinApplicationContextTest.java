...
//	
//		
//		materialPage=WeiXinApplicationContext.get_material_list(MaterialType.video,0,20);
...
//		assertEquals(1, newsMaterial.getNews_item().size());
		...
		//获取视频素材
		String media_id="0SdB8eTZZzlJ-NJv0pcmoznqrX7sNW53lk_1AT5v8fI";
		video的素材获取失败
		VideoMaterial videoMaterial=(VideoMaterial)WeiXinApplicationContext.get_material(media_id);
